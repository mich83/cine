...
class AsientosControllerTest < ActionController::TestCase
  ...
  test "should create asiento" do
    assert_difference('Asiento.count') do
      post :create, asiento: { numero: @asiento.numero, posicionX: @asiento.posicionX, posicionY: @asiento.posicionY }
    end
  ...
  test "should update asiento" do
    patch :update, id: @asiento, asiento: { numero: @asiento.numero, posicionX: @asiento.posicionX, posicionY: @asiento.posicionY }
    assert_redirected_to asiento_path(assigns(:asiento))
  end
